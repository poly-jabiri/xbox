...
public class NewsDBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.example.danialaswad.polynews/databases/";
    ...
    public List<News> getNewsFromDb(){
        ...
        while (!cursor.isAfterLast()){
            newsList.add(new News(cursor.getInt(0), cursor.getString(0), cursor.getString(1),
